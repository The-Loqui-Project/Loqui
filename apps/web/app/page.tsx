...
const slogans = [
  ...
  {
    text: "Bienvenido a nuestra comunidad global",
    language: "Spanish",
    flag: "🇪🇸",
  },
  {
    text: "Bienvenue dans notre communauté mondiale",
    language: "French",
    flag: "🇫🇷",
  },
  {
    text: "Willkommen in unserer globalen Gemeinschaft",
    language: "German",
    flag: "🇩🇪",
  },
  { text: "欢迎加入我们的全球社区", language: "Chinese", flag: "🇨🇳" },
  {
    text: "Benvenuti nella nostra comunità globale",
    language: "Italian",
    flag: "🇮🇹",
  },
  {
    text: "Добро пожаловать в наше глобальное сообщество",
    language: "Russian",
    flag: "🇷🇺",
  },
  {
    text: "グローバルコミュニティへようこそ",
    language: "Japanese",
    flag: "🇯🇵",
  },
  {
    text: "Bem-vindo à nossa comunidade global",
    language: "Portuguese",
    flag: "🇵🇹",
  },
  {
    text: "Welkom bij onze wereldwijde gemeenschap",
    language: "Dutch",
    flag: "🇳🇱",
  },
  {
    text: "Velkommen til vårt globale fellesskap",
    language: "Norwegian",
    flag: "🇳🇴",
  },
  {
    text: "Välkommen till vår globala gemenskap",
    language: "Swedish",
    flag: "🇸🇪",
  },
];
